        ...
        @extends('layouts.sidebar')
            <div id="layoutSidenav_content">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="container-fluid bg-white">
                            <div class="display-flex text-center p-3 "> 
                               
                                <img src="https://th.bing.com/th/id/OIP.RvFf4kISDpVvCzuotmYOzQHaEr?w=285&h=180&c=7&r=0&o=5&pid=1.7" alt="">
                                <span class="m-5"></span>
                                <img src="https://th.bing.com/th/id/OIP.OFfqlVWrOrWqBrLSUtRJmAHaEm?w=279&h=180&c=7&r=0&o=5&pid=1.7" alt="">
                            </div>
                        </div>
                        <div class="card  shadow round">      
