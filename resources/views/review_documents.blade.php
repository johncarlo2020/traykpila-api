                            ...
                            <div class="container-fluid bg-white ">
                                <div class="d-flex text-center p-3"> 
                                    <div class="col">
                                        ...
                                        <img class="myImg img-fluid img-thumbnail" 
                                        src="http://31.187.75.224/traykpila-api/storage/app/images/{{ $tricycle->or}} ?? 'http://31.187.75.224/traykpila-api/storage/app/images/default_image.jpg' }}" 
                                        width="400" 
                                        height="600" 
                                        alt="">
                                            <div id="myModal" class="modal">
                                    ...
                                    <img class="myImg img-fluid img-thumbnail" 
                                        src="'http://31.187.75.224/traykpila-api/storage/app/images/'{{ $tricycle->cr}} ?? 'http://31.187.75.224/traykpila-api/storage/app/images/default_image.jpg' }}" 
                                        width="400" 
                                        height="600" 
                                        alt=""></div>
                                </div>
